...
public interface CrewService {
    ...
    void assignCrewMemberOnMission(List<CrewMember> crewMembers, FlightMission flightMission) throws RuntimeException;

    // todo create custom exception for case, when crewMember is not able to be created (for example - duplicate.
    // crewmember unique criteria - only name!
    CrewMember createCrewMember(String crewMemberString) throws RuntimeException;
}